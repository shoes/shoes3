...
# osxcross system doen't require? 
#LINUX_CFLAGS << " -isysroot #{OSX_SDK} #{OSX_ARCH}"
#LINUX_LDFLAGS << " -isysroot #{OSX_SDK} #{OSX_ARCH}"
LINUX_LDFLAGS << " -L#{ShoesDeps}/lib/ #{GLIB_LDFLAGS}"

LINUX_LIBS = "#{RUBY_LDFLAGS} -l#{RUBY_SO} -L#{ShoesDeps}/lib -l cairo -L#{ShoesDeps}/lib -lpangocairo-1.0 -L#{ShoesDeps}/lib -lgif -ljpeg"
