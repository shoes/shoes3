...
class Shoes::Setup
   ...
   def initialize(script, &blk)
      ...
      @script = script
      instance_eval &blk
      app = self.class.setup_app(self) unless no_steps?
   end
