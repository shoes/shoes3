...
class Shoes
   ...
   def self.setup(&blk)
      ...
      @setups[line] = true
      raise SettingUp unless set.no_steps?
   end
      ...
      Shoes.app width: 598, height: 520, resizable: false do
         ...
         stack margin: 18 do
            ...
            stack do
               ...
               para link(strong("Run an App")) { Shoes.show_selector && close }, margin: 10, margin_bottom: 4
               para link(strong("Read the Manual")) { Shoes.show_manual && close }, margin: 10, margin_bottom: 4
               para link(strong("Maintain Shoes")) {Shoes.cobbler && close}, margin: 10, margin_bottom: 4
              ...
              # para link(strong("Profile an App")) {Shoes.profiler and close}, :margin => 10, :margin_bottom => 4
               para link(strong("Bundle an App (shy)")) { Shoes.package_app && close }, margin: 10, margin_bottom: 4
...
#  end
   ...
   def self.manual_link(_sect); end
